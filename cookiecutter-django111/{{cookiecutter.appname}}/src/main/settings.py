...
class Base(CachesMixin, DatabasesMixin, CompressMixin, PathsMixin, LogsMixin,
    ...
    APP_SLUG = opts.get('APP_SLUG', '{{cookiecutter.appname}}')
    SITE_ID = 1
    ...
    AWS_STORAGE_BUCKET_NAME = opts.get('AWS_STORAGE_BUCKET_NAME', '{{cookiecutter.appname}}')
    AWS_ACCESS_KEY_ID = opts.get('AWS_ACCESS_KEY_ID', '')
    AWS_SECRET_ACCESS_KEY = opts.get('AWS_SECRET_ACCESS_KEY', '')
    AWS_QUERYSTRING_AUTH = opts.get('AWS_QUERYSTRING_AUTH', '')
    AWS_DEFAULT_ACL = opts.get('AWS_DEFAULT_ACL', '')
